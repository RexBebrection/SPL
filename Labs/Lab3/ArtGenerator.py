...
class ArtGenerator:
    ...
    def _create(self, **kwargs):
        if 'font' in kwargs:
            ...
            font = self._font
        art = pyfiglet.Figlet(font=font, direction=self._direction, justify=self._justify, width=self._width)
        return self._color + art.renderText(self._message)
    ...
    def _art_zoom(self):
        return self._create(font='banner3')
